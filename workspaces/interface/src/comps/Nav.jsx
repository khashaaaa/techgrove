...
import { IconSearch, IconShoppingBag, IconLogin, IconUserPlus, IconDeviceMobile, IconDeviceIpad, IconDeviceImac, IconDeviceWatch, IconDeviceAirpods, IconDeviceLaptop, IconPower } from "@tabler/icons-react"
    ...
    return (
        <div>
            <div className="bg-cyan-900 h-16 flex items-center justify-between">
                ...
                <div className="flex">
                    <Link to="/shopcart">
                        <button type="button" className="text-white text-xs flex flex-col items-center mr-4 w-16 relative"><IconShoppingBag /><p className="absolute right-4 top-0 flex items-center justify-center bg-emerald-600 w-4 h-4 rounded-full font-bold">{count}</p>Сагс</button>
                    </Link>
                    {
                        access_token ?
                            <button onClick={Logout} type="button" className="text-white text-xs flex flex-col items-center mr-4 w-16"><IconPower />Гарах</button>
                            :
                            <>
                                <Link to="/login">
